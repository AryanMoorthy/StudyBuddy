...
import { GraduationCap, Mail, Lock, Loader2, UserPlus, ArrowRight, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-black text-foreground mb-2 tracking-tight">Join StudyBuddy</h1>
          <p className="text-muted-foreground font-medium text-center">Start your journey to organized learning</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground flex items-center gap-2 px-1">
              <CheckCircle2 className="w-4 h-4" /> Confirm Password
            </label>
            <input
              type="password"
              required
